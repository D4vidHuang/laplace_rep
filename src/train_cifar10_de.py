...
def train_single_model(model, dataloader, epochs=100, initial_lr=0.1, weight_decay=5e-4):
    ...
    optimizer = optim.SGD(model.parameters(), lr=initial_lr, momentum=0.9, nesterov=True, weight_decay=weight_decay)
